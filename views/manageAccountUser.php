...
<body>
        ...
        <div class="profile-content">
            <div class="content-section personal-info active">
                ...
                <form action="/updateUserProfile" method="POST">
                    <div class="form-left">
                    <input type="text" name="first_name" value="<?= $userData->getFirstName() ?? '' ?>"  placeholder="first name">
                    <input type="text" name="last_name" value="<?= $userData->getLastName() ?? '' ?>" placeholder="last name">
                    <input type="email" name="email" value="<?= $userData->getEmail() ?? '' ?>" placeholder="email address">
                    <input type="tel" name="phone" value="<?= $userData->getPhone() ?? '' ?>" placeholder="phone number">
                    <input type="text" name="city" value="<?= $userData->getCity() ?? '' ?>" placeholder="city">
                    <input type="text" name="street" value="<?= $userData->getStreet() ?? '' ?>" placeholder="street">
                    <input type="text" name="house_number" value="<?= $userData->getHouseNumber() ?? '' ?>" placeholder="house number">
                    <input type="text" name="apartment_number" value="<?= $userData->getApartmentNumber() ?? '' ?>" placeholder="apartment number">       
                    </div>
    ...
    <button type="button" class="add-pet-btn" style="display: block;">+ Add new pet</button>               <div class="pet-form" style="display: none;">
                    <form action="/addPet" method="POST">
                        <div class="pet-card">
                            <div class="pet-photo">
                                <img src="../Public/img/default-pet.svg" alt="Pet photo">
                                <input type="hidden" name="photo_url" value="../Public/img/default-pet.svg">
                            </div>
